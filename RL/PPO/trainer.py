...
class CustomPPOTrainer(PPO):
    def __init__(self, *args, normalize_value, lr_policy, lr_value, min_lr_policy, min_lr_value, amp_value, rescale_v, num_epochs, actors, raw_env = None, ct=None,**kwargs):
